...
public class FileUploadController {
    //WEB_INF 안에 upload만들면 보안이 걸려있어서 안됨
    //1,2는 개발서버 3,4는 운영서버 업로드
    ...
    public String upload1(HttpServletRequest request, HttpServletResponse response) {
        ...
        String uploadPath="d:/kim/spring1/study2/src/main/webapp/resources/upload";
    ...
    public String uploadFrom2(MultipartHttpServletRequest multipartRequest) throws ServletException, IOException {
