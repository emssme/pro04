            ...
            <form class="col s12 l6 offset-l3" action="fileUpload2" method="post" enctype="multipart/form-data">
                ...
                <div class="row center-align">
                    <div class="col s12 l8 offset-l2">
                        <div class="col s6">
                            <button type="button" id="btnAddFile" class="btn-large waves-effect waves-light">
...
<script>
    ...
    btnAddFile.addEventListener('click', function () {
        ...
        var input = '<div class="file-field input-field col s12"><div class="btn"><span><i class="material-icons left">attach_file</i>첨부 파일</span><input type="file" name="file" multiple></div><div class="file-path-wrapper"><input type="text" class="file-path validate"></div><span class="helper-text">첨부파일로 업로드 가능한 용량은 최대 50MB 입니다.</span></div>';
